"""Evaluate Clicky's visual locator against labeled screenshot cases.
...
from app.services.clicky_visual_locator import LocalizationResult, locate_visual_target  # noqa: E402
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare Clicky computer-use localization models")
    parser.add_argument("--manifest", required=True, type=Path)
    parser.add_argument(
        "--models",
        default=settings.clicky_visual_locator_trial_models,
