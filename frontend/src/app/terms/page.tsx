    ...
    <div style={{
      ...
      <main style={{ maxWidth: 800, margin: "0 auto", padding: "48px 24px 80px" }}>
        ...
        <section style={{ marginBottom: 32 }}>
          ...
          <p style={{ lineHeight: 1.7, color: "#334155" }}>
            If you choose to connect your Google Calendar, you grant Ctrl+Teach permission to read and create calendar events on your behalf for study scheduling purposes. You can revoke this access at any time through your Google Account settings. Our use of Google Calendar data is governed by our <Link href="/privacy" style={{ color: "#D4A574" }}>Privacy Policy</Link> and complies with Google&apos;s API Services User Data Policy.
          </p>
        </section>
